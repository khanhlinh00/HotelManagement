        ...
        public void AddNewCustomer(CustomerObject customer)
        {
            try
            {
                ...
                if (isEmpty == null)
                {
                    ...
                    parameters.Add(DataProvider.CreateParameter("@NameCustomer", 4, customer.CustomerName, DbType.String));
                    parameters.Add(DataProvider.CreateParameter("@Nationality", 4, customer.Nationality, DbType.String));
                    DataProvider.Insert(SQLInsert, CommandType.Text, parameters.ToArray());
                }
                else
                {
